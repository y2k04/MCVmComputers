...
public class WallTVRender extends EntityRenderer<EntityWallTV>{
	...
	public void render(EntityWallTV entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		MinecraftClient.getInstance().getItemRenderer().renderItem(new ItemStack(ItemList.ITEM_WALLTV), Mode.NONE, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, RandomUtils.nextInt());
		matrices.pop();
