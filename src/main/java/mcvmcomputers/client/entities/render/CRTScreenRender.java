...
public class CRTScreenRender extends EntityRenderer<EntityCRTScreen>{
	...
	public void render(EntityCRTScreen entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		MinecraftClient.getInstance().getItemRenderer().renderItem(new ItemStack(ItemList.ITEM_CRTSCREEN), Mode.NONE, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, new Random().nextInt());
