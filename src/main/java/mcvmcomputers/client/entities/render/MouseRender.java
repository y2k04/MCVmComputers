...
public class MouseRender extends EntityRenderer<EntityMouse>{
	...
	public void render(EntityMouse entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		MinecraftClient.getInstance().getItemRenderer().renderItem(new ItemStack(ItemList.ITEM_MOUSE), Mode.NONE, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, RandomUtils.nextInt());
		matrices.pop();
	}
