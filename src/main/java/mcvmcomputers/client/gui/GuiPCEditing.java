				...
				if(pc_case.getMotherboardInstalled()) {
					...
					if(pc_case.getGigsOfRamInSlot0() > 0) {
						...
						if(pc_case.getGigsOfRamInSlot0() < 1000 && pc_case.getGigsOfRamInSlot0() >= 100) {
							this.textRenderer.draw(ms, (int) pc_case.getGigsOfRamInSlot0() + " MB", this.width / 2f + 4, this.height / 2f + 2, -1);
						}else if(pc_case.getGigsOfRamInSlot0() < 100) {
							this.textRenderer.draw(ms, (int) pc_case.getGigsOfRamInSlot0() + " MB", this.width / 2f + 10, this.height / 2f + 2, -1);
						}else {
							this.textRenderer.draw(ms, (int) pc_case.getGigsOfRamInSlot0()/1024 + " GB", this.width / 2f + 16, this.height / 2f + 2, -1);
						}
						GL11.glPopMatrix();
						RenderSystem.enableDepthTest();
					...
					if(pc_case.getGigsOfRamInSlot1() > 0) {
						...
						if(pc_case.getGigsOfRamInSlot1() < 1000) {
							this.textRenderer.draw(ms, (int) pc_case.getGigsOfRamInSlot1() + " MB", this.width / 2f + 42, this.height / 2f + 2, -1);
						}else {
							this.textRenderer.draw(ms, (int) pc_case.getGigsOfRamInSlot1()/1024 + " GB", this.width / 2f + 42, this.height / 2f + 2, -1);
						}
						GL11.glPopMatrix();
						RenderSystem.enableDepthTest();
